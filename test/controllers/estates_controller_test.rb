...
class EstatesControllerTest < ActionController::TestCase
  ...
  test "should create estate" do
    assert_difference('Estate.count') do
      post :create, estate: { address: @estate.address, description: @estate.description, price: @estate.price, title: @estate.title, type: @estate.type }
    end
  ...
  test "should update estate" do
    patch :update, id: @estate, estate: { address: @estate.address, description: @estate.description, price: @estate.price, title: @estate.title, type: @estate.type }
    assert_redirected_to estate_path(assigns(:estate))
  end
